...
plt.xlabel('Days in June') #decalare th label of the x-axis
plt.ylabel('Number')   #declare the label of the y-axis
plt.suptitle("COVID-18 in June") #declare the title of the graph
