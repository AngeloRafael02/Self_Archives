    ...
    #   CLASS: describes what an object will be but is separate from the object itself, also called an instance?
...
class Animal:
    def __init__(self,name,color): #Superclass: Class the is inherited from
        self.name = name
        self.color = color
class Bird(Animal): #Subclass: Class that Inherits from another Class
    def BirdSound(self):
        print("Tweet!")
