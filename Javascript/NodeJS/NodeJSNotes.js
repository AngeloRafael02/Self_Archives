...
console.log(module1.pi*2);
    ...
    //EVENTS MODULE
const events = require('events'); //NodeJs's own Module
const customEmitter = new events.EventEmitter(); //made a new custom event emitter
customEmitter.on('click',function (message){ console.log(message); }); //made a callback function once a click event is emitted
customEmitter.emit('click', 'The event was Emitted'); //click event was emitted manually + function argument
