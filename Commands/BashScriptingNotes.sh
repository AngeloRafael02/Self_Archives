...
smbclient //<ip-address>/<SambaFile> -U username&password #Access Samba File server
smbclient //<ip-address>/<SambaFile> -U username #Access Samba File Server, Get password Prompt
